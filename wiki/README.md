---
description: "이 위키는 슈타인즈 게이트의 설정, 메커니즘, 사건을 체계적으로 정리한 한국어 해설서입니다. 작품을 처음 접한 분부터 설정을 깊이 파고드는 분까지 모두가 활용할 수 있도록 작성되었습니다."
---
...
| **[팬 분석]** | 팬이 작성한 체계적 해설 ([The Mechanics of Steins;Gate v1.0.3](./근거자료/비공식/mechanics-of-steins-gate/index.md), 어트랙터 필드 이론 등) | 추론·해석이 포함됨 |
...
```
wiki/
├── lore/           핵심 설정 해설 (세계선, 도구, 사건 등)
├── 캐릭터/         캐릭터별 해설
├── organization/   등장 조직 (세른, 라운더 등)
├── 세계선/         세계선별 상세 문서
├── 용어/           용어 정리
├── setting/        설정별 심층 분석
├── 근거자료/       원문 근거 자료
│   ├── 공식/       공식 QA자료집, 인터뷰 전문
│   └── 비공식/     팬 해설 (Mechanics of SG 등)
└── _template/      문서 작성 템플릿
```
