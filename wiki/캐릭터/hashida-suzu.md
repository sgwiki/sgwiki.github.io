...
하시다 스즈(橋田 鈴)는 《슈타인즈 게이트》 세계관에서 미래의 [아마네 스즈하](./amane-suzuha.md)가 2010년에서 1975년으로 타임머신을 타고 시간 여행을 한 뒤, 약 25년간 일본에서 정착하며 사용한 **가명**이다. 알파 세계선에서 확립된 정체로, [아키하 유키타카](./akiha-yukitaka.md)(페이리스의 아버지)에게 IBN 5100을 전달하고, 젊은 시절의 [마키세 쇼이치](./nakabachi.md)(훗날의 닥터 나카바치)에게 타임머신 이론을 가르친 스승으로서 이 작품의 인과 구조에서 결정적 역할을 수행한다.

2000년경 인터넷에 "[존 티터](./john-titor.md)"라는 필명으로 시간여행자임을 밝히며 활동했던 인물과도 동일인물로 해석되며, 같은 해 사망(또는 자살)한 것으로 전해진다. 사후 그가 남긴 편지가 2010년에 오카베 린타로에게 도달하면서, 스즈하의 임무가 완수된다.
...
|---|---|
| 가명 | 하시다 스즈(橋田 鈴) |
| 본체 | [아마네 스즈하](./amane-suzuha.md) |
| 사용 시기 | 1975년 ~ 2000년경 (약 25년) |
| 세계선 | 알파 세계선 한정 존재 |
| 공식 직함 | 물리학 교수 |
| 활동 무대 | 아키하바라, 도쿄 |
| 주요 역할 | IBN 5100 확보 및 전달, 타임머신 연구 지도, 존 티터로서의 인터넷 게시 |
| 주요 제자 | [마키세 쇼이치](./nakabachi.md)(닥터 나카바치) |
| 주요 후원자 | [아키하 유키타카](./akiha-yukitaka.md) |
| 최후 | 2000년경 사망(또는 자살) |
...
알파 세계선에서 아마네 스즈하는 SERN의 디스토피아 미래를 막기 위한 두 가지 임무를 띠고 2010년에 체류한다. 하나는 아버지 [하시다 이타루](./hashida-itaru.md)(다루)를 찾는 것이고, 다른 하나는 IBN 5100을 확보해 2010년의 오카베 일행이 SERN의 데이터베이스를 해킹할 수 있도록 길을 여는 것이다. 마침내 2010년 8월, 스즈하는 미스터 브라운 앞에서 타임머신에 탑승해 1975년으로 출발한다.
...
- **리딩 슈타이너 각성설**: [오카베 린타로](./okabe-rintaro.md)만이 발동하는 리딩 슈타이너(세계선 이동 기억 유지 능력)와 유사한 현상이 스즈하에게도 부분적으로 작용해, 기억 상실 상태에서도 자신의 정체 일부를 보존했다는 해석.
...
유키타카는 이 유언을 충실히 이행한다. 2000년에 하시다 스즈가 사망한 뒤, 유키타카는 [루카의 아버지](./urushibara-luka.md)(야나바 유키오)에게 IBN 5100을 맡기며 같은 말을 전하고, 훗날 페이리스와 집사 쿠로키가 이를 야나바야시 신사에 봉납한다. 2010년, 오카베가 그 신사에서 IBN 5100을 발견하고 차입하는 것으로 이 경로는 완성된다.
...
[닥터 나카바치](./nakabachi.md)의 인격과 행동은 하시다 스즈의 존재 여부에 의해 크게 갈린다.
...
1999-2000년경, 하시다 스즈는 기억이 서서히 회복되면서 자신의 임무를 다시 자각하게 된다. 이미 노환과 병세가 심화한 상태에서 그녀는 인터넷 게시판에 **[존 티터](./john-titor.md)**라는 필명으로 시간여행자임을 밝히며 활동을 시작한다. 존 티터 게시글에는 타임머신의 원리, 미래 정보, 세계선 구조 등이 담겨 있으며, 후일 오카베 린타로가 세계선의 존재를 이해하고 리딩 슈타이너를 깨닫는 결정적 계기를 제공한다.
...
- **[아마네 스즈하](./amane-suzuha.md)**: 본체. 2010년에서 1975년으로 타임머신을 타고 온 소녀가 바로 하시다 스즈의 본체다.
- **[아키하 유키타카](./akiha-yukitaka.md)**: 후원자이자 동료. IBN 5100을 맡긴 인물로, 사후 유언에 따라 기기를 야나바야시 신사에 봉납한다.
- **[닥터 나카바치](./nakabachi.md)(마키세 쇼이치)**: 제자. 알파 세계선에서는 직접 사사받아 인격이 보존되고, 베타 세계선에서는 인터넷 글로만 접해 인격이 변질된다.
- **[하시다 이타루](./hashida-itaru.md)(다루)**: 본체 스즈하의 생물학적 아버지. '하시다'라는 성 사용의 원천으로 해석된다.
- **[오카베 린타로](./okabe-rintaro.md)**: 2010년에 편지를 받는 인물. 하시다 스즈의 임무와 희생을 비로소 이해하게 된다.
- **[존 티터](./john-titor.md)**: 하시다 스즈가 인터넷에서 사용한 필명. 동일인물로 해석된다.
- **텐노지 유고(미스터 브라운)**: 하시다 스즈의 편지를 보관하다 2010년에 오카베에게 전달하는 중계자.

## 관련 문서

- [아마네 스즈하](./amane-suzuha.md)
- [아키하 유키타카](./akiha-yukitaka.md)
- [닥터 나카바치](./nakabachi.md)
- [하시다 이타루](./hashida-itaru.md)
- [오카베 린타로](./okabe-rintaro.md)
- [존 티터](./john-titor.md)
- [텐노지 유고](./tennoji-yugo.md)
- [루카(야나바 유키오)](./urushibara-luka.md)
