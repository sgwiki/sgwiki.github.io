...
- [[organization/라운더]] — 라운더 조직 소개 정전
- [[lore/SERN과-라운더]] — SERN-라운더 관계 정전
- [[lore/FB-코드네임과-라운더-지휘-체계]] — FB 코드네임 체계 정전
...
텐노지 유고는 "희생양 시스템의 정점에 선 동시에 그 시스템의 피해자"라는 모순적 위치에 있습니다. 어느 한쪽으로 단정하기보다, 라운더라는 조직이 구성원 전원을 희생양으로 구성하는 구조적 비극성(후술 쟁점 6)을 전제로 한 위에서 도덕 평가를 수행하는 것이 근거에 가깝습니다. 최종 판단은 독자에게 위임합니다.
...
**SERN 영향력 급감(제로 기반 해석)**은 슈타인즈 게이트 0에서 SERN이 마키세 크리스의 타임머신 논문을 입수하지 못하고 미국·러시아의 국가级 정보 조직에 밀려 "동네북"으로 전락하는 묘사를 근거 삼습니다. 타임머신 독점 체제가 무너진 베타 계열 세계선에서 SERN의 흑막 지위가 붕괴했으므로 라운더의 실질 위협도 현저히 낮아진다고 봅니다.
...
- [[organization/라운더]] — 라운더 조직 정전 문서
- [[lore/SERN과-라운더]] — SERN-라운더 관계 정전
- [[lore/FB-코드네임과-라운더-지휘-체계]] — FB 코드네임 체계 정전
- [[캐릭터/텐노지-유고]] — FB 정체 인물 정전
- [[캐릭터/키류-모에카]] — M4 정체 인물 정전
- [[커뮤니티-큐레이션/SERN-FAQ]] — SERN·Z 프로그램·디스토피아 인과 반복 질문 정리
