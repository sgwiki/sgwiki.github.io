...
**애니 오리지널 과장 주장**은 다음을 근거로 삼습니다. 모에카는 본편(α 세계선)에서 FB에게 버림받아 식음을 전폐한 쇠약 상태에서 오카베에게 제압당한 인물인데, 제로(β 세계선)에서는 군인들을 혼자 쓸어버리는 등 전투력이 비약적으로 상승해 있어 개연성이 부족하다는 지적입니다. "멘헤라 성향의 알바 모집 인원이 특수부대보다 강하다"는 비판도 같은 맥락입니다.
