...
- [다루(하시다 이타루)](../캐릭터/hashida-itaru.md) — 부녀 관계의 아버지 측 캐릭터
- [아마네 스즈하](../캐릭터/amane-suzuha.md) — 부녀 관계의 딸 측 캐릭터
- [다루-유키 관계](./daru-yuki-relationship.md) — 다루와 유키의 연인/부부 관계 서사
- [유키-스즈하 모녀 유대](./yuki-suzuha-maternal-bond.md) — 유키와 스즈하 사이의 모녀 본능 서사
- [오카베-다루 우정](./okabe-daru-friendship.md) — 다루가 오카베와 맺는 우정, 왈큐레의 기반
- [오카베-스즈하 관계](./okabe-suzuha-relationship.md) — 스즈하가 오카베와 맺는 협력 관계
- [존 티토](./john-titor.md) — 바렐 타이타와 연결되는 시간 여행자 전설
- [타임머신 모델](./time-machine-models.md) — 다루가 개발한 타임머신의 기술사
- [2036년 미래](./2036-future.md) — 부녀가 태어나고 활동한 디스토피아 미래 설정
- [수렴](./convergence.md) — 세계선 수렴이 부녀 관계의 인지 여부에 미치는 영향
- [다루의 기술 능력](./daru-technical-abilities.md) — 타임머신 개발을 가능하게 한 다루의 기술적 역량
