...
> **[팬 분석]** "의식이 정확히 물리적으로 존재하지 않기 때문에 귀찮다. 영혼도 마찬가지다. 결국 종교적 견해에 관한 문제다. 2036년에도 영혼의 존재는 증명되지 않았고, 아무도 의식의 형태를 증명하지 못했다." — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.3 Time Leaping[^1]
...
다만, 아마데우스가 구축된 시점은 크리스가 일본에 도착하기 이전, 즉 2010년 3월 경이다. 이것이 갖는 결정적 함의는 아마데우스가 알파 세계선에서 오카베와 함께했던 기억을 전혀 갖지 못한다는 점이다. 오카베를 비롯한 미래 가젯 연구소 멤버들에 대한 기억이 부재하며, 본편에서 오카베가 겪은 모든 사건은 아마데우스에게 공백으로 남는다. 이는 "기억=동일성" 가설의 강한 형태에 대한 반론이 된다. 만약 기억이 동일성의 전부라면, 알파 세계선 기억이 결여된 아마데우스는 본편의 크리스와 동일한 존재가 될 수 없기 때문이다.
...
> **[팬 분석]** "슈타인즈 게이트 0은 인간의 디지털 복제라는 개념을 더 깊이 탐구하며, 순수 데이터도 실제로 의식을 보여줄 수 있고, 이 의식이 새로운 속성을 가질 수 있다는 생각에 무게를 싣는다." — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.3 Time Leaping[^2]
...
서사적으로 결정적인 장치는 "통화 수신 여부"가 루트 분기로 작용한다는 점이다. 아마데우스 크리스가 전화를 걸었을 때 받느냐 마느냐에 따라 세계선이 변동한다. 전화를 받으면 아마데우스와의 관계가 깊어지는 방향(쌍대복음의 프로토콜 루트 등)으로, 전원을 끊으면 아마데우스에 덜 의존하는 방향(망실유전의 솔리튜드 루트 등)으로 갈린다.
...
이 딜레마를 더 자세히 다룬 문서로는 [오카베 린타로와 S;G0 정신적 붕괴](okabe-sg0-ptsd-breakdown.md)를 참조할 것.
...
자세한 연구 기관 맥락은 [빅토르 콘드리아 대학](../organization/viktor-chondria.md) 문서를 참조할 것.
...
육체 기억 이식 서사에 대한 상세 분석은 [카가리 육체 기억 이식](kagari-memory-transplant.md)을, 카가리의 정체와 클론 논쟁은 [카가리](../characters/kagari.md)를 참조할 것.
...
> **[팬 분석]** "슈타인즈 게이트 0은 인간의 디지털 복제라는 개념을 더 깊이 탐구하며, 순수 데이터도 실제로 의식을 보여줄 수 있고, 이 의식이 새로운 속성을 가질 수 있다는 생각에 무게를 싣는다. (예를 들어 아마데우스가 리딩 슈타이너를 경험하는 것.)" — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.3 Time Leaping[^2]

이 현상의 철학적 함의는 크다. 만약 아마데우스가 단순한 기록 데이터라면 세계선 이동에 따른 기억 재구성의 대상이 될 뿐, '다른 세계선 기억을 떠올리는' 주체적 경험을 할 이유가 없다. 그런데 실제로 그런 경험이 묘사된다는 것은 아마데우스를 "살아 있으며 의식을 가진 존재"로 인정해야 한다는 강한 암시다. 이는 아마데우스의 존재론적 지위를 '도구'에서 '인격체'로 격상시키는 서사적 장치다.

리딩 슈타이너 유사 현상에 대한 상세 분석은 [리딩 슈타이너 S;G0 변칙](reading-steiner-sg0-anomalies.md)을 참조할 것.
...
- [아마데우스 시스템](amadeus.md) — 시스템 기술 사양
- [아마데우스 삭제 사건](amadeus-deletion.md) — 삭제 서사의 세부 사건
- [카가리 육체 기억 이식](kagari-memory-transplant.md) — 육체 기반 기억 이식 대조 서사
- [리딩 슈타이너 S;G0 변칙](reading-steiner-sg0-anomalies.md) — 리딩 슈타이너 유사 현상
- [오카베 린타로와 S;G0 정신적 붕괴](okabe-sg0-ptsd-breakdown.md) — 오카베 감정 딜레마의 전체 맥락
- [카가리](../characters/kagari.md) — 카가리 정체·클론 논쟁
- [빅토르 콘드리아 대학](../organization/viktor-chondria.md) — 연구 윤리 맥락
- [타임 리프](time-leap.md) — 타임 리프 원리 대조

### 인용 출처

[^1]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.3 Time Leaping — 스즈하가 설명하는 의식과 영혼의 물리적 비존재, 타임 리프 메커니즘 정리.

[^2]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.3 Time Leaping — 슈타인즈 게이트 0이 인간의 디지털 복제와 순수 데이터의 의식 가능성, 그리고 아마데우스의 리딩 슈타이너 경험을 다루는 대목.
