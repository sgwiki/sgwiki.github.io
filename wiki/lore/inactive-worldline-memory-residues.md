...
> **[팬 분석]** "Everyone has the ability to remember other world lines to some extent, which manifests as dreams or feelings of deja vu." — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.3.2 Deja Vu[^1]
...
> **[공식]** "오카베가 1999년에 고열로 한 달간 쓰러졌던 사건은 리딩 슈타이너 각성과 관련되지만, 각성 이유 자체는 불명이다." — [슈타게 공식 QA자료집](../공식자료/qa-자료집.md), Q24[^2]
...
> **[공식]** "타임리프는 과거 오카베의 기억을 단순히 덮어쓰는 것이 아니라 미래의 기억을 떠올리는 방식으로 설명된다. 여러 번의 타임리프 기억은 A와 B처럼 서로 다른 미래 가능성으로 별도 보관된다." — [슈타게 공식 QA자료집](../공식자료/qa-자료집.md), Q28
