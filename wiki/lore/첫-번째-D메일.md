...
가능하며 설정오류가 아니다. [공식 QA자료집](../근거자료/공식/qa-자료집.md) Q25와 본편 9·10장이 명시적으로 확립한 메커니즘이다. 오퍼레이션 베르단디로 에셜론 DB 내 첫 D메일 레코드를 삭제하면 그 기록의 존재를 전제로 성립하던 알파 세계선의 인과가 재구성되어 베타(1.130205%)로 회귀한다.
