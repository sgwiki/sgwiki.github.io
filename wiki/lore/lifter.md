...
이 두 문제가 결합된 결과, 2001년 이후 약 100회에 가까운 인체실험 중 종적이 파악된 피험자는 14명에 불과하며, 나머지 80여 명은 "어디로 날아갔는지조차 확인되지 않았다". 발견된 14명의 시체 역시 모두 젤리맨 상태였고, 이는 리프터가 제 기능을 하지 못해 피험자가 사건의 지평선 내부의 초중력에 노출되었음을 의미한다. 자세한 사례는 [젤리맨즈 리포트](./jellymans-report.md)를 참조.
...
- [젤리맨즈 리포트](./jellymans-report.md)
- [D메일](./dmail.md)
- [타임리프 머신](./time-leap.md)
- [SERN](./sern.md)
...
[^1]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.2.2 "D-mails". 전화렌지가 미니 블랙홀을 생성하고 대형 CRT가 전자를 공급해 벌거벗은 특이점을 형성하는 메커니즘, 그리고 36바이트+α의 데이터 한계를 설명하는 절.
