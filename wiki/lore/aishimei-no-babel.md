...
본작에서 다루어진 비하인드 설정(나카바치와 유키타카의 관계, 하시다 스즈 교수의 논문과 인과 루프, 크리스의 심리 묘사 등)은 이후 [선형구속의 페노그램](linear-bounded-phenogram.md)에서 대거 활용된다. 이 점에서 애심미도의 바벨은 단순한 외전을 넘어 시리즈 설정의 확장 기점으로서 의미를 갖는다.
...
[^1]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.1.1 "World Lines" — 세계선의 정의와 수속 구조.
