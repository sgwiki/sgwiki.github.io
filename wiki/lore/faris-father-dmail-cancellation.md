...
- [아키하 유키타카](../캐릭터/akiha-yukitaka.md)
...
- [비활성 세계선의 기억 잔재](inactive-worldline-memory-residues.md)
- [아마네 스즈하](../캐릭터/amane-suzuha.md)

## 인용 출처

[^1]: [슈타인즈 게이트 공식 QA자료집](../근거자료/공식/qa-자료집.md) — Q14 (IBN 5100 보관 경로)
[^2]: [슈타인즈 게이트 공식 QA자료집](../근거자료/공식/qa-자료집.md) — Q16 (Ω 세계선 음수 다이버전스)
[^3]: [슈타인즈 게이트 공식 QA자료집](../근거자료/공식/qa-자료집.md) — Q18, Q21-Q23 (알파 미래와 인물 수속)
[^4]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §자체 일관성 있는 루프
