...
이 수속은 [수속(convergence)](convergence.md) 메커니즘의 가장 복잡한 사례 중 하나로, [마유리 사망 수속](mayuri-death-convergence.md)이 단일 어트랙터 필드 내의 단기적 비극이라면, 2025년 수속은 양 어트랙터 필드에 공통으로 작용하며 15년이라는 장기 시간 창을 갖는 거시적 구조이다.

## 2. 대수속 메커니즘

### 2.1 수속이란 무엇인가

[수속(convergence)](convergence.md)은 동일 [어트랙터 필드](attractor-field.md)에 속하는 모든 세계선이 필연적으로 도달하게 되는 공통 결과를 의미한다. 수속점(convergence point)은 "결과만 같다면 과정은 관계없다"는 원리로 작동하며, 따라서 사건의 원인·경로·세부 양상은 세계선마다 달라질 수 있지만 최종 결과 상태는 고정된다. 어트랙터 필드가 다르면 수속의 내용 자체가 바뀌므로, 수속은 절대적인 것이 아니라 어트랙터 필드 범위에 국한된 규칙이다.

오카베의 2025년 수속은 알파 필드와 베타 필드 양쪽에서 관측되는 특이한 케이스다. 양쪽 모두 "2025년에 오카베가 사망(또는 그에 준하는 상태)한다"는 결과로 수렴하지만, 그 의미와 맥락은 필드마다 상이하다.
...
| 특성 | 내용 |
|---|---|
| 시간 창 | 2025년 전후 (구체적으로 2025년 8월 21일이 핵심 기점) |
...
알파 어트랙터 필드의 특정 세계선에서, 성인이 된 텐노지 나에는 2025년에 아버지 텐노지 유고(미스터 브라운)의 죽음과 라보멤의 비극적 운명에 대한 복수심으로 오카베를 추적하여 고문 끝에 사망에 이르게 한다. 이 사건은 작품의 핵심 설정이 아니라 특정 루트(드라마 CD, 외전 소설 등)에서 묘사되는 수속의 구체적 발현 형태 중 하나로, "결과는 같지만 과정이 다르다"는 수속 원리의 극단적 사례다.

이 루트에서 나에가 오카베를 고문하며 남긴 말—2025년의 오카베가 알파 세계선에서 겪는 비극의 한 단면—은 오카베에게 깊은 트라우마를 남기며, 이후 세계선 이동에서도 [리딩 슈타이너](reading-steiner.md)를 통해 기억이 전이되는 현상과 결부된다.
...
2. 2034년 SERN 타임머신 완성 → 디스토피아 체제 확립
...
베타 어트랙터 필드에서 2025년 수속의 의미는 알파와는 다른 맥락을 갖는다. 베타 필드의 거시적 수속은 [크리스 사망 수속](convergence.md)(2010년 7월 28일)과 [제3차 세계대전 수속](third-world-war.md)이며, 2025년은 전쟁이 한창 진행 중이거나 막바지에 이른 시기다.
...
근본적 해결은 오직 [슈타인즈 게이트 세계선](steins-gate-worldline.md)(1.048596%)으로의 이탈뿐이다. 이 세계선은 알파와 베타 어트랙터 필드의 경계에 위치하여 양쪽 수속 어디에도 속하지 않으며, 따라서 2025년 수속 자체가 적용되지 않는다. 오카베 제로가 15년에 걸쳐 연구하고 [노스탤지어 드라이브](nostalgia-drive.md)를 통해 과거의 자신에게 전달한 [오퍼레이션 스쿨드](operation-skuld.md)의 목적이 바로 이 이탈을 달성하는 것이다.

## 6. N.D mail (Nostalgia Drive) 타임라인

### 6.1 2025-08-21 18:00 사건 기점

2025년 8월 21일 18:00은 베타 필드에서 오카베 제로가 [노스탤지어 드라이브(Nostalgia Drive, N.D mail)](nostalgia-drive.md)라는 영상 D메일을 녹화·송신하는 결정적 시점이다. 이 영상은 36바이트 제한을 넘어선 용량 제한 없는 D메일 송신 장치를 통해 2010년 7월 28일의 오카베에게 전달되며, 그 내용에는 오퍼레이션 스쿨드의 구체적 지시가 담겨 있다.

이 시점이 8월 21일인 것은 우연이 아니다. 본편에서 2010년 8월 21일은 오카베가 크리스 구출 1차 시도에 실패하고 절망에 빠진 날이며, 바로 그 순간 휴대전화에 저장된 영상 메일이 재생 가능한 상태로 변화하는 날이다. 2025년 송신 시점과 2010년 수신·확인 시점이 8월 21일로 일치하는 것은, 인과적 루프의 자기 일관성을 보여주는 구조적 필연이다.
...
- **C204 타임머신**: 크리스(Christina)의 머리글자를 딴 모델명. SERN이 최초로 개발하고 크리스가 개선했으며, 다루와 오카베가 완성한 설계에 기반.

이 영상이 2010년의 오카베에게 전달됨으로써, 오퍼레이션 스쿨드가 성립하고 슈타인즈 게이트 세계선 도달의 길이 열린다.

### 6.3 아마데우스 시스템의 이용

[아마데우스(Amadeus)](amadeus.md) 시스템은 S;G 0에서 2025년 수속 회피와 N.D mail 전달 과정에 깊이 관여한다. 아마데우스는 마키세 크리스의 기억 데이터를 기반으로 제작된 신경망 AI로, β 세계선에서 사망한 크리스의 기억과 사고방식을 보존하고 있다.
...
[오퍼레이션 아크라이트(Operation Arc Light)](operation-arclight.md)는 마유리와 스즈하가 고안한 작전으로, 2011년에서 2010년 8월 21일로 타임머신을 타고 이동하여 절망에 빠진 오카베를 각성시키는 것이 목적이다. 이 작전은 베타 드라마 CD, S;G 0 비주얼 노벨의 Vega and Altair 챕터, S;G 0 애니메이션 등 여러 매체에서 묘사된다.
...
> **[팬 분석]** "We infer that Mayuri encouraging Okabe is not sufficient to make him to go on to save Kurisu, because the Operation Skuld D-mail does not exist yet to instruct him further. (The slap is still important however, because it will make him receptive to that D-mail when the time comes.)" — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §3.1.2[^1]
...
[존 티터(John Titor)](john-titor.md)는 2000년과 2000년~2001년에 인터넷에 등장한 자칭 시간여행자로, 자신이 2036년에서 왔다고 주장했다. 슈타인즈 게이트 세계관에서는 아마네 스즈하가 존 티터(작중 표기로는 존 타이타)라는 가명으로 활동하며, 이 실존 전설이 작품의 핵심 모티브로 차용된다.
...
> **[팬 분석]** "At the highest level, Steins;Gate is the story of many different Okabes struggling against fate. Their successes and failures accumulate, in the form of changes to the world line structure, dreams of past experiences, and knowledge transmitted by Suzuha. Eventually, an Okabe brings all those pieces come together, allowing him to save his friends and escape the cycle that trapped his predecessors." — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §2.6.1[^2]
...
[The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf)는 2025년 수속의 경계 조건을 어트랙터 필드의 범위와 연결하여 분석한다. 핵심 논지는 다음과 같다.
...
> **[팬 분석]** "오카베는 타임머신을 타고 나서 영상 메일을 보냈기 때문에 구하러 가는 장면은 문제가 되지 않는다. 마유리는 2011년, 스즈하는 2036년으로 각각 돌려보내야 하며, 오카베는 2025년에 죽는 것이 수속이기 때문에 세계선에서 사라진다." — [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf), §3.1.2[^3]
...
- [세계선 (Worldline)](worldline.md): 세계선 일반의 정의와 활성/비활성 세계선의 구분
- [어트랙터 필드 (Attractor Field)](attractor-field.md): 어트랙터 필드의 구조와 수속 범위
- [수속 (Convergence)](convergence.md): 수속 메커니즘 일반과 핵심 수속 사건 정리
- [다이버전스 미터 (Divergence Meter)](divergence-meter.md): 세계선 변동률 측정 장치

### 핵심 수속 사건

- [마유리 사망 수속 (Mayuri Death Convergence)](mayuri-death-convergence.md): 알파 필드의 단기 수속 (2010년 8월 13일)
- [마유리 구출 루프 (Mayuri Rescue Loop)](mayuri-rescue-loop.md): 오카베의 타임리프 반복 서사
- [2036년 미래 (Future 2036)](2036-future.md): 2036년 거시적 미래와 스즈하 출발
- [제3차 세계대전 (Third World War)](third-world-war.md): 베타 필드의 거시적 수속

### 작전

- [오퍼레이션 스쿨드 (Operation Skuld)](operation-skuld.md): 크리스 구출과 슈타인즈 게이트 도달의 최종 작전
- [오퍼레이션 아크라이트 (Operation Arc Light)](operation-arclight.md): 마유리·스즈하의 과거 이동 작전
- [오퍼레이션 알타이르 (Operation Altair)](operation-altair.md)
- [오퍼레이션 베르단디 (Operation Verdandi)](operation-verdandi.md)

### 핵심 설정·기술

- [노스탤지어 드라이브 (Nostalgia Drive)](nostalgia-drive.md): 2025년 오카베가 보낸 영상 D메일
- [아마데우스 (Amadeus)](amadeus.md): 크리스 기반 신경망 AI 시스템
- [D메일 (D-Mail)](dmail.md): 과거로 전송되는 메일
- [타임머신 (Time Machine)](time-machine.md): 물리적 시간여행 장치
- [리딩 슈타이너 (Reading Steiner)](reading-steiner.md): 오카베의 세계선 이동 기억 유지 능력
- [타임 리프 (Time Leap)](time-leap.md): 기억의 과거 전송 기술

### 작품

- [슈타인즈 게이트 (Steins;Gate)](steins-gate.md): 본편
- [슈타인즈 게이트 0 (Steins;Gate 0)](steins-gate-0.md): 베타 필드 후속작
- [슈타인즈 게이트 0 TVA (2018)](sg0-anime-2018.md): 애니메이션 판

### 인물

- [존 티터 (John Titor)](john-titor.md): 2036년 시간여행자 전설과 스즈하의 가명
- [루프 폐쇄 (Loop Closure)](loop-closure.md): 시간여행 루프의 자기 일관성
...
- **S;G 0 (비주얼 노벨 및 2018년 애니메이션)**: 베타 필드에서의 오카베 서사, 아마데우스 시스템, 오퍼레이션 아크라이트, 2025년 N.D mail 녹화·송신, 3000회 이상의 타임리프와 호오인 쿄우마 각성.
- **S;G 0 TIPS**: 수속과 어트랙터 필드의 공식 정의.
- **S;G 공식 QA자료집**: 크리스 사망 수속의 관측 조건, 스쿨드 1차 실패의 성격, 베타 스즈하의 타임머신 경유지 등.

### 팬 분석

- **The Mechanics of Steins;Gate v1.0.3** (Votuko 저, GitHub 공개): 오퍼레이션 아크라이트의 루프 폐쇄 분석(§3.1.2), 오퍼레이션 스쿨드의 위장 논리(§3.1.3), 반복(iteration) 순서 정리(§2.6.1), 잘못된 팬 이론 반박(§4.4~4.5). [PDF 원문](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf).
...
[^3]: [The Mechanics of Steins;Gate v1.0.3](https://github.com/Votuko/steins-gate-mechanics/blob/main/The%20Mechanics%20of%20Steins%20Gate%20v1.0.3.pdf) — §3.1.2 Operation Arc Light 요약.
