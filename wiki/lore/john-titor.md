...
- [타임머신](./time-machine.md) — FG204(α), C204(β) 등 작중 타임머신 기체.
- [세계선](./worldline.md) — 어트랙터 필드 내에서 활성/비활성 상태로 존재하는 세계의 단위.
- [어트랙터 필드](./attractor-field.md) — α, β, SG, ω 필드의 구조와 수속 미래.
- [다이버전스](./divergence.md) — 세계선 변동률. 1.048596%가 슈타인즈 게이트 세계선.
- [아마네 스즈하](../characters/amane-suzuha.md) — 존 타이타의 정체. α·β 양쪽에서 활동.
- [SERN](./sern.md) — α 세계선에서 타임머신을 독점해 디스토피아를 건설.
- [리딩 슈타이너](./reading-steiner.md) — 오카베의 세계선 이동 시 기억 유지 능력. 존 타이타가 명명.
- [수렴](./convergence.md) — 어트랙터 필드 내에서 반드시 일어나는 사건.
- [오퍼레이션 스쿨드](./operation-skuld.md) — β 세계선에서 슈타인즈 게이트 세계선으로 이탈하기 위한 작전.
